...
export default function Footer() {
  return (
    <footer className="w-full">
      ...
      {/* BLOCO MARROM — IGUAL AO SITE DA BRENDA */}
      <div className="w-full bg-[#8C3A54] text-white py-16 text-center px-6">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 mt-10">
          ...
          {/* AGENDAR */}
          <a
            href="https://wa.me/5585XXXXXXX?text=Olá!%20Quero%20agendar%20uma%20consulta."
            target="_blank"
            rel="noopener noreferrer"
            className="border border-white text-white !text-white hover:opacity-90 transition text-white py-4 px-8 rounded-full flex items-center gap-2"
          >
      ...
      {/* PARTE FINAL — BEGE IGUAL AO MODELO */}
      <div className="w-full bg-[#F4E7E4] py-12 text-center px-6">
        ...
        <div className="text-sml font-serif text-[var(--vinho)] mb-14">
          <p className="text-lg font-serif text-[var(--vinho)] mb-3">Endereço</p>
          <p>R. Monsenhor Bruno, 1153 – Meireles, Fortaleza–CE</p>

          <p className="text-sml font-serif text-[var(--vinho)] mb-6">Estamos à disposição para orientações.</p>
          <p>📞 (85) 9 9288-3317</p>
      <div className="flex justify-center gap-6 mt-6 text-3xl">

        {/* BOTÃO WHATSAPP */}
        <a
          href="https://wa.me/558585992883317text=Olá!%20Gostaria%20de%20mais%20informações."
          target="_blank"
          rel="noopener noreferrer"
        ...
        {/* COPYRIGHT */}
        <p className="text-sml font-serif text-[var(--vinho)] mb-14">
